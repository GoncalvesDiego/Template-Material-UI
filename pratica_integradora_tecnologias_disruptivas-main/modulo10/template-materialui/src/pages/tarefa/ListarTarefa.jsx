...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        <Button variant="contained" sx={{ backgroundColor: '#4caf50', color: 'white' }} onClick={() => handleEditar(row.idTarefa)}><EditIcon fontSize="small" /></Button>            
                      </TableCell>
                      <TableCell align="center">
                        <Button variant="contained" sx={{ backgroundColor: '#f44336', color: 'white' }} onClick={() => handleDeletar(row.idTarefa)}><DeleteIcon fontSize="small" /></Button>            
                      </TableCell>
                    </TableRow>
                ))}
                </TableBody>
        ...
        <CardActions>
        <Button size="small" variant="contained" onClick={handleOpen} sx={{ backgroundColor: '#4caf50', color: 'white', marginRight: '8px' }}>
  Criar Tarefa
</Button>
